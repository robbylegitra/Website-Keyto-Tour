...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 27, 2021 at 11:25 AM
...
CREATE TABLE `faq` (
  ...
  `pertanyaan_faq` longtext NOT NULL,
  `jawaban_faq` longtext NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `paket_tour` (
  ...
  `pdf_paket` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
ALTER TABLE `paket_tour`
  MODIFY `id_paket` int(2) NOT NULL AUTO_INCREMENT;
COMMIT;
