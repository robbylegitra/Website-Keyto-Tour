  ...
  <body>
    ...
    <div class="container">
          <ul class="nav nav-tabs">
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="<?= base_url('c_admin'); ?>">Carousel</a>
            </li>
            <li class="nav-item">
      ...
      <br>
       <a href="<?= base_url('c_tbcarousel'); ?>" class="text-right"><button class="btn btn-warning">Tambah Banner</button></a>
    </div>
